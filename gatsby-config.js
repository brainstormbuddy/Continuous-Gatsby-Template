module.exports = {
  siteMetadata: {
    title: `Continuous – Make Better Product Decisions, Faster`,
    description: `Continuous is a free landing page template built on TailwindCSS and Gatsby. Made by Maksim.`,
